...
At the time of writing this I am using R version 4.4.2 `Pile of Leaves` [@R-base]. If you do not have this version or something newer it may make sense to update so that you can follow along without pesky version issues.
...
Read more about this from [Hadley Wickham's paper](www.jstatsoft.org/v59/i10/paper) in the *Journal of Statistical Software*.
...
# look at the 'Arguments' section of the help file for the 'n' argument
?head
```
