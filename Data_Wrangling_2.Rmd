...
```{r wrangle2-participants-data, exercise=TRUE}
...
```{r wrangle2-names-participants-data, excercize = TRUE}
names(participants_data)
```

- Look at the structure of the data with the `str` function

```{r wrangle2-str-participants-data, excercize = TRUE}
