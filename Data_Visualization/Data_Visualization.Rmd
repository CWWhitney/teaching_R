...
```{r setup_data_vis, include=FALSE}
...
<img src="images/Circos.png" style="background:none; border:none; box-shadow:none;height="200"; width="200";"><img src="images/INRES_Logo.png" style="background:none; border:none; box-shadow:none;height="100"; width="100";"><img src="images/Uni_Bonn_Picture.png" style="background:none; border:none; box-shadow:none;height="200"; width="200";"><img src="images/ZEF_Logo.png" style="background:none; border:none; box-shadow:none;height="200"; width="200";">
...
knitr::include_graphics('images/hadley_wickham.png')
```
Hadley Wickham
```{r, out.width='50%', fig.align='center', echo=FALSE}
...
<small>Load data</small> <img src="images/R_logo.png" style="background:none; border:none; box-shadow:none;height="10%"; width="10%";">
...
<small>Want to understand how all the pieces fit together? See the R for Data Science book: http://r4ds.had.co.nz/</small>
