...
<iframe width="560" height="315" src="https://www.youtube.com/embed/J1JjUPzA1mA" frameborder="0" allowfullscreen></iframe>
...
- In RStudio on your maching find **Help > Cheatsheets > Data Visualization with ggplot2**
...
```{r vis-vis-ggplot_name_email-solution}
ggplot(data = participants_data, 
...
```{r vis-boxplot_jitter, fig.width=20, fig.height=5, fig.align='center'}
...
# Change this animation as you like
