...
- Add `R` to an internet search quesry with a copy of any error message you get from R
...
- Import your own data or data from an external source (e.g. FAO, World Bank)
- Display those data using ggplot tools (feel free to animate it)
